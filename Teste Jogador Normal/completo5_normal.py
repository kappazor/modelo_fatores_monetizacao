...
def completo5f2p_dp():
    for morte in mortes:
        mortes_dp.append((morte - completo5f2p_media()) ** 2)
...
def completo5f2p_ic_superior():
    x = completo5f2p_media()
    o = completo5f2p_dp()
    n = len(mortes)
    completo5f2p_lim_superior = round(x + z * (o / (n ** (1 / 2))), 2)
    return completo5f2p_lim_superior


def completo5f2p_ic_inferior():
    x = completo5f2p_media()
    o = completo5f2p_dp()
    n = len(mortes)
    completo5f2p_lim_inferior = round(x - z * (o / (n ** (1 / 2))), 2)
    return completo5f2p_lim_inferior
