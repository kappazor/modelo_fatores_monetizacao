...
def completo25f2p_media():
    media = round(statistics.mean(mortes), 2)
    return media


def completo25f2p_dp():
    for morte in mortes:
        mortes_dp.append((morte - completo25f2p_media()) ** 2)
...
def completo25f2p_ic_superior():
    x = completo25f2p_media()
    o = completo25f2p_dp()
    n = len(mortes)
    completo25f2p_lim_superior = round(x + z * (o / (n ** (1 / 2))), 2)
    return completo25f2p_lim_superior


def completo25f2p_ic_inferior():
    x = completo25f2p_media()
    o = completo25f2p_dp()
    n = len(mortes)
    completo25f2p_lim_inferior = round(x - z * (o / (n ** (1 / 2))), 2)
    return completo25f2p_lim_inferior


def completo25f2p_erro():
    completo25f2p_yerr = round(completo25f2p_ic_superior() - completo25f2p_media(), 2)
    return completo25f2p_yerr
