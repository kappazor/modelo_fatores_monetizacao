...
def completo10f2p_media():
    media = round(statistics.mean(mortes), 2)
    return media


def completo10f2p_dp():
    for morte in mortes:
        mortes_dp.append((morte - completo10f2p_media()) ** 2)
...
def completo10f2p_ic_superior():
    x = completo10f2p_media()
    o = completo10f2p_dp()
    n = len(mortes)
    completo10f2p_lim_superior = round(x + z * (o / (n ** (1 / 2))), 2)
    return completo10f2p_lim_superior


def completo10f2p_ic_inferior():
    x = completo10f2p_media()
    o = completo10f2p_dp()
    n = len(mortes)
    completo10f2p_lim_inferior = round(x - z * (o / (n ** (1 / 2))), 2)
    return completo10f2p_lim_inferior
